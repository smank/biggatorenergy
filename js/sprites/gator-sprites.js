...
const ADULT_IDLE = [
  ...
  [_, _, _, _, D, D, B, B, B, B, B, B, B, B, B, B, N, N, _, _, _, _, _, _],
  [D, D, D, D, B, B, B, B, B, B, B, B, B, B, B, B, D, D, _, _, _, _, _, _],
  [_, D, D, V, V, V, V, V, V, V, V, V, V, V, V, B, N, N, _, _, _, _, _, _],
...
const ADULT_EAT = [
  [_, _, _, _, _, _, _, _, S, S, S, S, _, _, _, _, _, _, _, _, _, _, _, _],
  [_, _, _, _, _, _, _, S, D, S, D, S, S, _, _, _, _, _, _, _, _, _, _, _],
  [_, _, _, _, _, _, D, B, B, B, B, B, B, E, P, D, D, T, T, _, _, _, _, _],
  [_, _, _, _, D, D, B, B, B, B, B, B, B, B, B, B, N, N, D, _, _, _, _, _],
  [D, D, D, D, B, B, B, B, B, B, B, B, B, B, _, _, _, _, _, _, _, _, _, _],
  [_, D, D, V, V, V, V, V, V, V, V, V, V, V, B, B, N, N, D, _, _, _, _, _],
  [_, _, V, V, V, V, V, V, V, V, V, V, V, V, D, D, T, T, _, D, D, D, D, D],
  [_, _, _, V, _, _, _, V, _, _, _, V, _, _, _, _, _, D, D, _, _, _, _, _],
  [_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _],
];
...
const ADULT_SWIM = [
  ...
  [_, _, _, _, D, D, B, B, B, B, B, B, B, B, B, B, N, N, _, _, _, _, _, _],
  [D, D, D, D, B, B, B, B, B, B, B, B, B, B, B, B, D, D, _, _, _, _, _, _],
  [_, D, D, D, V, V, V, V, V, V, V, V, V, V, V, B, N, N, _, _, _, _, _, _],
...
const ELDER_BLINK = [
  ...
  [_, _, _, _, _, _, D, D, B, B, B, B, B, B, B, B, B, B, N, N, _, _, _, _, _, _, _, _],
  [_, _, _, D, D, D, B, B, B, B, B, B, B, B, B, B, B, B, D, D, _, _, _, _, _, _, _, _],
  [D, D, D, B, B, B, B, B, B, B, B, B, B, B, B, B, B, B, N, N, _, _, _, _, _, _, _, _],
  [_, D, D, V, V, V, V, V, V, V, V, V, V, V, V, V, V, V, B, D, _, _, _, _, _, _, _, _],
  [_, _, V, V, V, V, V, V, V, V, V, V, V, V, V, V, B, _, _, _, D, D, D, D, D, D, D, D],
  [_, _, _, V, _, _, _, _, V, _, _, _, V, _, _, _, _, _, _, D, D, _, _, _, _, _, _, _],
  [_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _],
...
const ELDER_EAT = [
  [_, _, _, _, _, _, _, _, _, _, S, S, S, S, S, _, _, _, _, _, _, _, _, _, _, _, _, _],
  [_, _, _, _, _, _, _, _, _, S, D, S, D, S, D, S, _, _, _, _, _, _, _, _, _, _, _, _],
  [_, _, _, _, _, _, _, _, D, B, B, B, B, B, B, B, E, P, D, D, T, T, _, _, _, _, _, _],
  [_, _, _, _, _, _, D, D, B, B, B, B, B, B, B, B, B, B, N, N, D, _, _, _, _, _, _, _],
  [_, _, _, D, D, D, B, B, B, B, B, B, B, B, B, B, _, _, _, _, _, _, _, _, _, _, _, _],
  [D, D, D, B, B, B, B, B, B, B, B, B, B, B, B, B, B, B, N, N, D, _, _, _, _, _, _, _],
  [_, D, D, V, V, V, V, V, V, V, V, V, V, V, V, V, V, V, D, D, T, T, _, _, _, _, _, _],
  [_, _, V, V, V, V, V, V, V, V, V, V, V, V, V, V, B, _, _, _, D, D, D, D, D, D, D, D],
  [_, _, _, V, _, _, _, _, V, _, _, _, V, _, _, _, _, _, _, D, D, _, _, _, _, _, _, _],
  [_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _],
];
...
const ELDER_SWIM = [
  ...
  [_, _, _, D, D, D, B, B, B, B, B, B, B, B, B, B, B, B, D, D, _, _, _, _, _, _, _, _],
  [D, D, D, B, B, B, B, B, B, B, B, B, B, B, B, B, B, B, N, N, _, _, _, _, _, _, _, _],
  [_, D, D, D, D, D, D, D, D, D, D, D, D, D, D, D, D, D, D, D, _, _, _, _, _, _, _, _],
  [_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, D, D, D, D, D, D, D, D],
  [_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _],
  [_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _],
];
